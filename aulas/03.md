...
O objetivo desta aula é implementar um sistema de cadastro de usuários na nossa aplicação. Ao final, você será capaz de cadastrar, listar, alterar e deletar usuários, além de realizar testes para validar estas funcionalidades.
...
Nesta aula, nosso foco principal será desenvolver um sistema de cadastro de usuários. Para isso, a implementação de uma forma eficiente para criar novos usuários na base de dados é essencial. Vamos explorar como utilizar o verbo HTTP POST, que é fundamental para comunicar ao serviço a nossa intenção de enviar novos dados, como no caso do cadastro de usuários.
...
Vamos usar o endpoint em seu estado atual, sem nenhuma resposta e ver o que o que acontecerá com a nossa requisição:

![descrição](assets/03/erro_500_no_swagger.png){: .center .shadow }
