...
### [WIP] Validação da resposta

> TODO: por conta do endpoint não responder nada
...
![descrição](assets/03/request_correto_para_post_com_resposta_incorreta.png){: .center .shadow }

> TODO: Fazer uma requisição correta e mostrar o erro 500

![descrição](assets/03/erro_500_do_servidor.png){: .center .shadow }
