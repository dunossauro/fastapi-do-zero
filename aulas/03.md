...
--8<-- "aulas/codigos/03/fast_zero/app.py:11:18"
```
...
--8<-- "aulas/codigos/03/fast_zero/schemas.py:8:11"
```
...
--8<-- "aulas/codigos/03/fast_zero/schemas.py:14:17"
```
...
--8<-- "aulas/codigos/03/fast_zero/schemas.py:8:18"
```
...
--8<-- "aulas/codigos/03/tests/test_app.py:4:26"
```
...
--8<-- "aulas/codigos/03/fast_zero/schemas.py:24:"
```
...
--8<-- "aulas/codigos/03/fast_zero/app.py:69:81"
```
...
```python title="tests/test_app.py" linenums="43"
--8<-- "aulas/codigos/03/tests/test_app.py:43:56"
```
...
--8<-- "aulas/codigos/03/fast_zero/app.py:84:91"
```
