...
Vale lembrar que, embora nossa constante `SECRET_KEY` é utilizada para assinar o token. Embora só esteja sendo usada nesse momento para entender o comportamento, seria bom gerar uma chave segura e não conhecida por pessoas de fora da aplicação. Fazendo com que ninguém possa validar a assinatura da chave.
