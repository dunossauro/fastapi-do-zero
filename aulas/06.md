...
```python title="fast_zero/app.py" hl_lines="14 19"
...
1. Faça um teste para cobrir o cenário que levanta expcetion `credentials_exception` na autenticação. Ao olhar a cobertura de `secutiry.py` você vai notar que esse contexto não está coberto.
