...
Para isso, o Python conta com a biblioteca nativa [`secrets`](https://docs.python.org/pt-br/3.14/library/secrets.html) focada exclusivamente em gerar segredos.
...
Isso gerará um token de 32 caracteres, que você pode usar para substituir sua `SECRET_KEY`. Talvez ainda não seja um bom momento para fazer isso, pois ela irá ser *commitada* no seu repositório do git. Mas, vamos resolver isso na [aula 07](07.md#adicionando-as-constantes-a-settings).
