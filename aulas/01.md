...
7. **OPCIONAL**: O [pipx](https://github.com/pypa/pipx){:target="_blank"} pode te
 ...
 7. **OPCIONAL (extremamente recomendado)**: O [gh](https://cli.github.com/){:target="_blank"} para criar o repositório e fazer alterações sem precisar acessar a página do Github
