...
![Figura representando a divisão para "protocolo" com "http://" , "endereço" com "127.0.0.1" e "porta" com ":8000"](assets/01_endereco_http_black.png#only-light){: .center }
![Figura representando a divisão para "protocolo" com "http://" , "endereço" com "127.0.0.1" e "porta" com ":8000"](assets/01_endereco_http_white.png#only-dark){: .center  }
...
Configuraremos o blue para somente para excluir o caminho das migrações quando forem utilizadas:
...
![navegador](assets/02_navegador_com_pagina_inicial_do_coverage.png){: .center }

Se clicarmos no arquivo `fast_zero/app.py` podemos ver em vermelho as linhas que não estão sendo testadas:

![navegador](assets/02_navegador_com_pagina_de_cobertura_sem_testes.png){: .center  }
...
![browser](assets/02_navegador_com_pagina_de_cobertura_com_estrutuda_de_testes.png){: .center  }
...
![descrição](assets/02_navegador_com_pagina_de_cobertura_com_teste.png){: .center }
