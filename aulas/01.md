...
6. [Docker](https://www.docker.com/){:target="_blank"}: Para criar um container da nossa aplicação
7. **OPCIONAL**: O [pipx](https://github.com/pypa/pipx){:target="_blank"} pode te
 ...
 7. **OPCIONAL**: O [gh](https://cli.github.com/){:target="_blank"} para criar o repositiŕio e fazer alterações sem precisar acessar a página do github
