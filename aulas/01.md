...
> 🚨🚨 Caso você precise de ajuda com a instalação dessas ferramentas, temos [um apêndice especial para te ajudar com isso!](apendices/instalacoes.md){:target="_blank"}. Basta clicar em achar a ferramenta que deseja instalar! 🚨🚨
...
--8<-- "aulas/codigos/01/pyproject.toml:19:22"
```
