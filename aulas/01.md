...
5. [Git](https://git-scm.com/){:target="_blank"}: Para gerenciar versões do nosso projeto. (Caso precise de um tutorial legal sobre git, o [TeoMeWhy](https://www.youtube.com/playlist?list=PLvlkVRRKOYFQ3cfYPjLeQ0KvrQ8bG5H11){:target="_blank"} fez uma playlist muito legal, totalmente de graça)
...
> 🚨🚨 Caso você precise de ajuda com a instalação dessas ferramentas, temos [um apêndice especial para te ajudar com isso!](/apendices/instalacoes/){:target="_blank"}. Basta clicar em achar a ferramenta que deseja instalar! 🚨🚨
...
??? question "Caso queira usar o pipx e não o tenha instalado no seu ambiente"
	O [pipx](https://pipx.pypa.io/stable/) é uma forma de instalar pacotes de forma global no seu sistema sem que eles interfiram no seu ambiente global do python. Ele cria um ambiente virtual isolado para cada ferramenta.
