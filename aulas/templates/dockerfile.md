	...
	5. `EXPOSE 8000`: informa ao Docker que o contêiner escutará na porta 8000.
	6. `CMD uvicorn --host 0.0.0.0 fast_zero.app:app`: define o comando que será executado quando o contêiner for iniciado.
