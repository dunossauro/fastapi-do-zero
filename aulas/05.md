...
<!--toc:start-->
- [Integrando Banco de Dados a API](#integrando-banco-de-dados-a-api)
  - [Integrando SQLAlchemy à Nossa Aplicação FastAPI](#integrando-sqlalchemy-à-nossa-aplicação-fastapi)
  - [Gerenciando Dependências com FastAPI](#gerenciando-dependências-com-fastapi)
  - [Modificando o Endpoint POST /users](#modificando-o-endpoint-post-users)
    - [Testando o Endpoint POST /users com Pytest e Fixtures](#testando-o-endpoint-post-users-com-pytest-e-fixtures)
      - [Threads e conexões](#threads-e-conexões)
  - [Modificando o Endpoint GET /users](#modificando-o-endpoint-get-users)
    - [Testando o Endpoint GET /users](#testando-o-endpoint-get-users)
    - [Criando uma fixture para User](#criando-uma-fixture-para-user)
    - [Integrando o Schema ao Model](#integrando-o-schema-ao-model)
  - [Modificando o Endpoint PUT /users](#modificando-o-endpoint-put-users)
    - [Adicionando o teste do PUT](#adicionando-o-teste-do-put)
  - [Modificando o Endpoint DELETE /users](#modificando-o-endpoint-delete-users)
    - [Adicionando testes para DELETE](#adicionando-testes-para-delete)
  - [Cobertura e testes não feitos](#cobertura-e-testes-não-feitos)
  - [Commit](#commit)
