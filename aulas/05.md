...
Desta forma, a senha não será mais criada em texto plano no objeto `User`. Fazendo com que caso exista algum problema relacionado a vazamento de dados, a senha das pessoas nunca seja exposta.
