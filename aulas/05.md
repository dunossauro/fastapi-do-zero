...
> TODO: Aqui entra o conceito de branch de cobertura. Vamos alterar o [tool.pytest] e conversar um pouco mais sobre os ifs!
...
Se quisermos que os testes rodem em ordem randômica todas as vezes, poderíamos adicionar isso na configuração em `pyproject.toml`. Isso poderia ser feito tanto na configuração `pytest` quando no `taskipy`. Vou adicionar a do pytest que está um pouco mais simples:
