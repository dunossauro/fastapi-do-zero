# [WIP] Autenticação e Autorização com JWT

Tópico de manutenção: https://github.com/dunossauro/fastapi-do-zero/issues/30
...
É igualmente importante modificar a função `update_user` para também criar um hash da senha antes de atualizar o usuário no banco de dados. Caso contrário, a senha em texto puro seria armazenada no banco de dados no momento da atualização.
