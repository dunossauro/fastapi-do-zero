...
Alguns problemas podem ser encontrador durante a criação dos relacionamentos com SQLAlchemy, então segue uma cola simples caso sinta que travou.
...
Criar um projeto utilizando git e hospedado em alguma plataforma (github/gitlab/codeberg/...) e postar [nessa issue](...){:target="_blank"}. Ao final, juntarei todos os projetos finais em uma tabela [nesse site](...){:target="_blank"} para que as pessoas possam aprender com as diferenças entre os projetos.
