...
3. **Instalar as dependências do projeto**: farante que todas as bibliotecas necessárias estão disponíveis para a execução dos testes.
...
??? info "Configurando Secrets pela Interface Web"
	...
	=== "1 - Acesse Settings no seu repositório"
		...
		![descrição](assets/10_passo_1_secrets.png){: .center .shadow }
