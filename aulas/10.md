...
```py title="tests/conftest.py" linenums="6" hl_lines="4 11"
...
1. Faz o import do `PostgresContainer` dos testcontainers.
...
> WIP: Explicar o escopo de inicialização único de uma fixture
