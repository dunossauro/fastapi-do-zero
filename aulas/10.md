...
```py title="Erro do CI!" hl_lines="7"
tests/test_app.py::test_root_deve_retornar_200_e_ola_mundo ERROR

==================================== ERRORS ====================================
__________ ERROR at setup of test_root_deve_retornar_200_e_ola_mundo ___________

self = <sqlalchemy.engine.base.Connection object at 0x7ffa5f162610>
engine = Engine(***localhost:5432/app_db)
```

> Aqui o erro é das variáveis de ambiente `localhost:5432/app_db` está setado
