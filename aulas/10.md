...
Dessa forma, a fixture é inicializada antes de todos os testes, está disponível durante a execução das funções e é finalizada após a execução de todos os testes.

#### [NF] Fixture para engine
