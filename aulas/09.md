...
!!! note "Execução em modo desanexado"
	Você pode iniciar os serviços em segundo plano com a flag `-d` usando `docker-compose up -d`. Isso fará com que os containers sejam executados em backgroud, fazendo com que o seu terminal não fique travado executando o compose.
