...
![descrição](assets/11_erro_na_aplicação_falta_de_migração.png){: .center .shadow width="800" }
...
![descrição](assets/11_funcionamento_apos_migração.png){: .center .shadow }
