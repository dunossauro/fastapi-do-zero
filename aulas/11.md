...
[Código :fontawesome-solid-code:](https://github.com/dunossauro/fastapi-do-zero/tree/main/codigo_das_aulas/11/){ .md-button }
...
=== "Guia Actions ->"
	![Captura de tela da aba Actions do repositório exibindo o workflow "instalação do python" e mostrando que foi executado com sucesso](assets/11/print_da_aba_actions_go_repositório.png){: .center .shadow }

=== "Jobs executados ->"

	![descrição](assets/11/print_do_status_geral_do_workflow_no_actions.png){: .center .shadow }

=== "Steps executados"
	![descrição](assets/11/print_dos_passos_executados_no_workflow_parte_1.png){: .center .shadow }
...
![descrição](assets/11/execucao_dos_testes_com_erro_de_ambiente.png){: .center .shadow }
...
??? info "Configurando Secrets pela Interface Web"
	...
	=== "1 - Acesse Settings no seu repositório"
		...
		![descrição](assets/11/passo_1_secrets.png){: .center .shadow }
	=== "2 - Adicione um novo segredo"
		...
		![descrição](assets/11/passo_2_secrets.png){: .center .shadow }
	...
	=== "3 - Visualização dos segredos"
		...
		![descrição](assets/11/passo_3_com_todas_as_variaveis_adicionadas.png){: .center .shadow }
...
![descrição](assets/11/print_erro_no_ci_por_nao_econtrar_o_db.png){: .center .shadow }
...
ERROR tests/test_app.py::test_root_deve_retornar_ok_e_ola_mundo - sqlalchemy.exc.OperationalError: (psycopg2.OperationalError) connection to server at "localhost" (::1), port 5432 failed: Connection refused
