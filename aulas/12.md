...
- **Logs**: registros de eventos importantes do nosso sistema. Por exemplo: se quiséssemos saber todas as vezes que alguém registrou um usuário ou adicionou uma tarefa no banco de dados. Poderíamos escrever isso em um arquivo de texto ou até mesmo enviar para um servidor de logs para vermos isso de forma remota e entender um pouco sobre os eventos que estão ocorrendo em produção.
...
- **Tracing**: rastreamento do que acontece na aplicação. 
- **Métricas**:
