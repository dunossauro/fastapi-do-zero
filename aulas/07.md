...
> TODO: Nem todos os testes vão passar!
...
```python linenums="1" title="/tests/test_auth.py" hl_lines="6"
from http import HTTPStatus
...
> TODO: O teste vai falhar ele usa a secret key como base, precisa ser alterado para:

```py title="/tests/test_security.py" linenums="1" hl_lines="3 11"
