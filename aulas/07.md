...
Uma boa pratica de organização seria usar um modelo do pydantic especializado em filtros, algo como:
...
Dessa forma, temos um modelo padrão de filtro e qualquer endpoint que precisar paginar resultados podem se beneficiar desse modelo.
