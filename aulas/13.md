...
![captura de tela da janela de tweak da aplicação](assets/12/fly_lauch_tweak_01.png){: .center .shadow width="500" }
...
![captura de tela da janela de tweak da aplicação](assets/12/fly_lauch_tweak_02.png){: .center .shadow width="500" }
...
![descrição](assets/12/erro_na_aplicação_falta_de_migração.png){: .center .shadow width="800" }
