...
!!! tip "Um exemplo básico"
    Um exemplo básico de uso de Asyncio + FastAPI pode ser encontrado no [apêndice B](/apendices/b_proximos_passos/#asyncio){:target="_blank"}.
...
!!! tip "Um exemplo básico"
    Um exemplo básico de uso de tarefas em segundo plano pode ser encontrado no [apêndice B](/apendices/b_proximos_passos/#tarefas-em-segundo-plano-background){:target="_blank"}.
