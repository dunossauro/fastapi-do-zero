...
> TODO: Ajustar esse print

![descrição](assets/08/coverage_mostrando_que_o_put_não_foi_testado_com_usuario_errado.png){: .center }
...
```py title="fast_zero/security.py" hl_lines="5 32 33"
