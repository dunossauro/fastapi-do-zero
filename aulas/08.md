...
Embora o SQLAlchemy ofereça suporte à programação assíncrona, esse suporte não vem completo por padrão. Um dos componentes necessários, o pacote [`greenlet`](https://github.com/python-greenlet/greenlet){:target="_blank"}, não é instalado automaticamente, com o objetivo de manter o pacote base mais enxuto. O `greenlet` é responsável por viabilizar corrotinas cooperativas dentro do SQLAlchemy, o que permite a execução eficiente de código assíncrono.
