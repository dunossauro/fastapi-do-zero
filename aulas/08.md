...
**WIP**:
  - Adicionar execução dos testes faltantes!
...
```python title="fast_zero/routes/todos.py" hl_lines="12 13"
...
Desa forma, garantimos que somente os campos enviados ao schema sejam atualizados no objeto.
