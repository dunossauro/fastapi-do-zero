...
Em nosso código, ele é usado para rodar a criação e exclusão das tabelas no banco de dados de forma síncrona dentro do contexto assíncrono. Como o SQLAlchemy foi configurado para ser assíncrono, mas ainda possui algumas operações que não podem ser feitas de forma assíncrona, o run_sync é o método adequado para fazer isso de maneira segura e eficiente.
